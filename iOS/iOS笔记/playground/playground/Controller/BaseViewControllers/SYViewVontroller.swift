...
// URLReachAble support
extension SYViewController {
    func startController(path: String, extras: [String: Any]? = nil) {
        let intent = Intent.init(pathIdentifier: path)
    ...
    func startController(intent: Intent) -> Void {
