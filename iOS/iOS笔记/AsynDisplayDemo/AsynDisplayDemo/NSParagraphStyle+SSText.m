...
@interface NSParagraphStyle_YCYGText : NSObject @end
@implementation NSParagraphStyle_YCYGText @end

@implementation NSParagraphStyle (SSText)

+ (NSParagraphStyle *)ss_styleWithCTStyle:(CTParagraphStyleRef)CTStyle {
...
- (CTParagraphStyleRef)ss_CTStyle CF_RETURNS_RETAINED {
